...
## 当前进度
请读取 `.harness/sprints/[FEATURE_ID]/sprint-1-progress.md` 了解已完成和待执行的任务。
...
每个任务完成后，更新 `.harness/sprints/[FEATURE_ID]/sprint-1-progress.md`：
...
```bash
# 开始 Sprint 1
"请读取 .harness/sprints/[FEATURE_ID]/sprint-1.md 和 .harness/prompts/generator.md，
 开始执行 Day 1 批次 1.1"

# 继续执行（新会话）
"请读取 .harness/sprints/[FEATURE_ID]/sprint-1-progress.md，
 继续执行下一个未完成的任务"
