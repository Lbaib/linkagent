...
# 产出：.harness/metrics/[FEATURE_ID]/perf-archive/{task-id}.json
# 工程师付出：0（hook 自动调用）
#
...
ARCHIVE_DIR=".harness/metrics/[FEATURE_ID]/perf-archive"
mkdir -p "$ARCHIVE_DIR"
...
INDEX_FILE=".harness/metrics/[FEATURE_ID]/perf-index.jsonl"
